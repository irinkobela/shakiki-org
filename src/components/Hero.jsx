...
const Hero = ({ content, scrollTo }) => {
    ...
    return (
        <section ref={ref} id="top" className={`bg-gray-50 fade-in-section ${isVisible ? 'is-visible' : ''}`} style={{ backgroundImage: 'radial-gradient(circle at top right, #E0E7FF 0%, #F3F4F6 40%)' }}>
